...
/*  Created On : 09-Sep-2019 11:51:10 AM 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"IDPEDIDO" NUMBER(8) NULL,
	"CEDULA" NUMBER(8) NULL,
	"IDCLIENTEPEDIDO" NUMBER(8) NOT NULL
)
;
...
(
	"IDMODODEPAGO" NUMBER(8) NOT NULL,
...
(
	"IDPRODUCTOREGION" NUMBER(8) NOT NULL,
	"PRECIO" NUMBER(8,2) NULL,
	"IDREGION" NUMBER(8) NULL,
	"IDPRODUCTO" NUMBER(8) NULL
)
;
...
(
	"IDENTIFICACION" NUMBER(8) NOT NULL,
...
CREATE INDEX "IXFK_Cliente_Pedido_Cliente"   
 ON  "Cliente_Pedido" ("CEDULA") 
;
